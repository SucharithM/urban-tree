      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mb-16"> 
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6"> 
            {features.map((feature, index) => ( <Card key={index} className="p-6 hover:shadow-lg transition-shadow border-border"> <feature.icon className="w-12 h-12 text-primary mb-4" /> 
        ...
        <div className="bg-primary/5 rounded-lg p-8 md:p-12 border border-border"> 
          ...
          <p className="text-center text-muted-foreground max-w-3xl mx-auto"> To advance scientific understanding of The Terrestrial Biogeochemistry Group investigates how plants and soils regulate the movement of carbon, nutrients, and water in terrestrial ecosystems under a variety of human perturbations. The group is located at University of Massachusetts Lowell in the Department of Environmental, Earth, and Atmospheric Sciences and is lead by Dr. Joy Winbourne.</p>
        </div> 
      </div>
